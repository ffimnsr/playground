...
pub fn footer() -> Html {
    let socials = html!{
        <div class="flex justify-center space-x-6 md:order-2">
            <a href="https://t.me/" class="text-gray-900 hover:text-gray-500">
            ...
            <a href="https://www.linkedin.com/in/" class="text-gray-900 hover:text-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" stroke="currentColor" class="size-6">
            ...
            <div class="mx-auto max-w-7xl px-6 py-4 md:flex md:items-center md:justify-between lg:px-8">
                ...
                <div class="mt-8 md:order-1 md:mt-0">
                    <p class="text-center text-xs leading-5 text-gray-500">
                        {"© 2024 Se-same. All rights reserved."}
                    </p>
                </div>
            </div>
        </footer>
