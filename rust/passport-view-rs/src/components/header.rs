            ...
            <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex flex-1">
                    <div class="hidden lg:flex lg:gap-x-12 text-gray-900">
                        ...
                        <Link<Route> to={Route::Home} classes="text-sm font-semibold leading-6">{"About"}</Link<Route>>
                        <Link<Route> to={Route::Home} classes="text-sm font-semibold leading-6">{"Contact Us"}</Link<Route>>
                    </div>
