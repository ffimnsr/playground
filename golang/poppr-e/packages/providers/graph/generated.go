...
func (ec *executionContext) field_Mutation_createProvider_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewProvider2githubᚗcomᚋffimnsrᚋpopprᚑprovidersᚋgraphᚋmodelᚐNewProvider(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createProvider(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateProvider(rctx, fc.Args["input"].(model.NewProvider))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNProvider2ᚖgithubᚗcomᚋffimnsrᚋpopprᚑprovidersᚋgraphᚋmodelᚐProvider(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Provider_userId(ctx context.Context, field graphql.CollectedField, obj *model.Provider) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Query_providers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Provider)
	fc.Result = res
	return ec.marshalNProvider2ᚕᚖgithubᚗcomᚋffimnsrᚋpopprᚑprovidersᚋgraphᚋmodelᚐProviderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewProvider2githubᚗcomᚋffimnsrᚋpopprᚑprovidersᚋgraphᚋmodelᚐNewProvider(ctx context.Context, v interface{}) (model.NewProvider, error) {
	res, err := ec.unmarshalInputNewProvider(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNProvider2githubᚗcomᚋffimnsrᚋpopprᚑprovidersᚋgraphᚋmodelᚐProvider(ctx context.Context, sel ast.SelectionSet, v model.Provider) graphql.Marshaler {
	return ec._Provider(ctx, sel, &v)
}

func (ec *executionContext) marshalNProvider2ᚕᚖgithubᚗcomᚋffimnsrᚋpopprᚑprovidersᚋgraphᚋmodelᚐProviderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Provider) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProvider2ᚖgithubᚗcomᚋffimnsrᚋpopprᚑprovidersᚋgraphᚋmodelᚐProvider(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProvider2ᚖgithubᚗcomᚋffimnsrᚋpopprᚑprovidersᚋgraphᚋmodelᚐProvider(ctx context.Context, sel ast.SelectionSet, v *model.Provider) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
